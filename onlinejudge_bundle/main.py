...
def main(args: Optional[List[str]] = None) -> None:
    ...
    parser.add_argument(
        ...
        help='add the directory dir to the list of directories to be searched for header files during preprocessing (default: ".")',
    )
    ...
    sys.stdout.buffer.write(
        language.bundle(
            parsed.path,
            basedir=parsed.iquote[0],
            options={"include_paths": parsed.iquote},
        )
    )

...
class TestDocsSubcommand(unittest.TestCase):
    ...
    def test_documentation_of(self) -> None:
        ...
        files = {
            ...
            pathlib.Path(
                "src", "a", "b", "unsupported-absolute.hpp"
            ): random_unsupported_absolute_hpp.encode(),
            pathlib.Path(
                "src", "a", "b", "no-document.hpp"
            ): random_no_document_hpp.encode(),
            pathlib.Path("docs", "x", "y", "relative.md"): textwrap.dedent(
                f"""\
                ---
                title: relative.md
            ...
            pathlib.Path("docs", "x", "y", "unsupported-absolute.md"): textwrap.dedent(
                f"""\
                ---
            ...
            pathlib.Path("docs", "x", "y", "absolute.md"): textwrap.dedent(
                f"""\
                ---
                title: absolute.md
            ...
            pathlib.Path("docs", "x", "y", "standalone-page.md"): textwrap.dedent(
                f"""\
                ---
        ...
        expected: Dict[pathlib.Path, List[str]] = {
            ...
            / "a"
            / "b"
            / "relative.hpp.md": [random_relative_hpp, random_relative_md],
            destination_dir
            / "src"
            / "a"
            / "b"
            / "absolute.hpp.md": [random_absolute_hpp, random_absolute_md],
            destination_dir
            / "src"
            / "a"
            / "b"
            / "unsupported-absolute.hpp.md": [
                random_unsupported_absolute_hpp,
                random_unsupported_absolute_md,
            ],
            destination_dir
            / "src"
            / "a"
            / "b"
            / "no-document.hpp.md": [random_no_document_hpp],
            destination_dir
            / "docs"
            / "x"
            / "y"
            / "standalone-page.md": [random_standalone_page_md],
        }
